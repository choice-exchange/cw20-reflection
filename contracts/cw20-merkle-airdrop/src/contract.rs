...
pub fn execute_burn_all(
    ...
    let total_amount = match (cfg.cw20_token_address.clone(), cfg.native_token.clone()) {
        (Some(cw20_addr), None) => {
...
mod tests {
    ...
    fn register_merkle_root() {
        ...
        let msg = ExecuteMsg::RegisterMerkleRoot {
            merkle_root: "64191cad95ef407fa0ca2bad006bcaa93744bd79ed61f9dcacb858d701e50661"
                .to_string(),
            expiration: None,
            start: None,
            total_amount: None,
        ...
        assert_eq!(
            ...
            vec![
                ...
                attr(
                    "merkle_root",
                    "64191cad95ef407fa0ca2bad006bcaa93744bd79ed61f9dcacb858d701e50661",
                ),
                attr("total_amount", "0"),
            ]
        );
        ...
        assert_eq!(
            "64191cad95ef407fa0ca2bad006bcaa93744bd79ed61f9dcacb858d701e50661".to_string(),
    ...
    fn claim_cw20() {
        ...
        let info = mock_info("owner0000", &[]);
        let msg = ExecuteMsg::RegisterMerkleRoot {
            merkle_root: "64191cad95ef407fa0ca2bad006bcaa93744bd79ed61f9dcacb858d701e50661".to_string(),
            expiration: None,
            start: None,
            total_amount: None,
            hrp: None,
        ...
        let msg = ExecuteMsg::Claim {
            ...
            stage: 1u8,
            proof: vec![
                "53ddba238881e85454d6d882cbbcf0c61ae5b3368508bfebc574dca229e45072".to_string(),
                "136eaadeb3b03623ebc22c3998d65f301c7e74f7c149e1a0df07a5453e217be9".to_string(),
                "ca6b81984558fedfd3807b5e89447add8cfb3e68d3d55c4cd08d5dba75f24141".to_string(),
                "d8abecc1e343d355a56a3110f6c0349336584c83454cc33f2621df0e73d7558c".to_string(),
                "66fd50ffdb2ace8f76588c0b247927d80e74d356deff2718c07d86b594139fac".to_string(),
                "9466aa618d7e78bb0ae7cf2190faa445885c69fbc79fc872f12496acdb3cfc28".to_string(),
                "c6421f52595bb4da0029ce56d881b0d023240c6a42aea677a693ba420b6f8ad1".to_string(),
                "0d992a4e93fe618369497c2c380a24d563f63cfc9ff96afaec016446a0068ea8".to_string(),
                "1b562fff632399804c9f1e9acdfea68cca4d5d3de6062dac09b56cd9cdb6b5c8".to_string(),
                "5fe9aad0d7307647fc2c6e7bef4c3a6f148ef15e56809f43770291e13fef6a89".to_string(),
                "ffe9dc527bfd582d1695639765955c19049a36d612fac9d115a18dcc94a74e99".to_string(),
                "65cafe5b8f827cfb4d3c46f4290638059bd8975a5a711c9e14d0ef45d6cf4143".to_string(),
                "8211cd4b0a31aee5ed8763de092db43cd8b51ca6e9a545dce5b659a33dad78a5".to_string()
              ],
            sig_info: None,
        };
    ...
    fn can_burn_all_cw20() {
        ...
        let cw20_merkle_airdrop_id = router.store_code(contract_cw20_merkle_airdrop());
        ...
        let cw20_merkle_airdrop_instantiate_msg = InstantiateMsg {
            owner: Some("owner0000".to_string()),
            cw20_token_address: Some(cw20_addr.to_string()),
            native_token: None,
        };

        let cw20_merkle_airdrop_addr = router
            .instantiate_contract(
                cw20_merkle_airdrop_id,
                Addr::unchecked("owner0000".to_string()),
                &cw20_merkle_airdrop_instantiate_msg,
                &[],
                "Airdrop Test",
                None,
            )
        ...
        router
            .execute_contract(
                Addr::unchecked("owner0000".to_string()),
                cw20_merkle_airdrop_addr.clone(),
                &register_msg,
                &[],
            )
            .unwrap();

        let mint_recipient = Addr::unchecked(cw20_merkle_airdrop_addr.to_string());
    ...
    fn can_withdraw_all_cw20() {
        ...
        let new_balance: BalanceResponse = router
            ...
            .unwrap();
        assert_eq!(Uint128::new(6000), new_balance.balance);
        //check the recipient balance
        let recipient_balance: BalanceResponse = router
            .wrap()
            .query_wasm_smart(
                &cw20_addr,
                &cw20_base::msg::QueryMsg::Balance {
        ...
        let recipient_balance: BalanceResponse = router
            ...
            .unwrap();
        assert_eq!(Uint128::new(6000), recipient_balance.balance);
    }
